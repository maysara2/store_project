...
<div class="container">
    <div class="row">
        <div class="col-md-4 col-xs-12 col-sm-4">
            ...
            <a href="tel:00972594841338">
                <i class="tf-ion-ios-telephone"></i>
                <span>00972-59-484-1338</span>
            </a>
            </div>
        </div>
        <div class="col-md-4 col-xs-12 col-sm-4">
            ...
            <ul class="top-menu text-right list-inline">
                ...
                <li class="dropdown search dropdown-slide">
                    ...
                    <ul class="dropdown-menu search-dropdown">
                        <li>
                            <form action="{{ route('site.search') }}" method="GET"><input type="search" name="s" class="form-control" placeholder="Search..."></form>
                        </li>
                    </ul>
                </li><!-- / Search -->
    ...
    <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse text-center">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown full-width dropdown-slide open">
                    <a href="#!" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="350" role="button" aria-haspopup="true" aria-expanded="true">Categories <span class="tf-ion-ios-arrow-down"></span></a>
