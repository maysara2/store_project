...
{{--
                    ...
                    paypal.Buttons({
                      ...
                      createOrder: function(data, actions) {
                        return actions.order.create({
                          purchase_units: [{"description":"This is  test store ","amount":{"currency_code":"USD","value":1}}]
                        });
                      },
 ...
 <form action="{{ route('site.payment') }}" class="paymentWidgets" data-brands="VISA PAYPAL MASTER AMEX MADA"></form>
